...
void readValue(Message::Ptr& value, const QJsonObject& json, const QString& valueName)
{
    if (json.contains(valueName) && json[valueName].isObject())
    {
        ...
        readArray(value->m_entities, object, "entities");
        ...
        readArray(value->m_photo, object, "photo");
        ...
        readArray(value->m_caption_entities, object, "caption_entities");
        ...
        readArray(value->m_new_chat_members, object, "new_chat_members");
        readValue(value->m_left_chat_member, object, "left_chat_member");
        readValue(value->m_new_chat_title, object, "new_chat_title");
        readArray(value->m_new_chat_photo, object, "new_chat_photo");
